...
num_first_res = float(input("Input first day res: "))
num_target_res = float(input("Input terget res: "))
num_day = 1
while num_target_res > num_first_res:
    num_first_res *= 1.1
    num_day += 1
    # print(num_day, num_first_res)

print("Mission complete on", num_day, "day.")
